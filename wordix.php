...
function obtenerPuntajeWordix($cantIntentos, $palabraEncontrada)  
{
    ...
    "N"=>3,"P"=>3,"Q"=>3,"R"=>3,"S"=>3,"T"=>3,"V"=>3,"W"=>3,"X"=>3,"Y"=>3,"Z"=>3 ];

    for ($i=0; $i < 5; $i++){
        $letraDePalabraEncontrada = $palabraEncontrada[$i];
        $puntaje += $puntosLetras[$letraDePalabraEncontrada];
    }
